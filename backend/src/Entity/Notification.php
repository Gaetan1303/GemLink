...
class Notification
{
    ...
    public const TYPE_FACTION_JOIN_REQUEST = 'FACTION_JOIN_REQUEST';
    public const TYPE_FACTION_JOIN_ACCEPTED = 'FACTION_JOIN_ACCEPTED';
    public const TYPE_FACTION_JOIN_REJECTED = 'FACTION_JOIN_REJECTED';
    public const TYPE_FACTION_MEMBER_PROMOTED = 'FACTION_MEMBER_PROMOTED';
    public const TYPE_FACTION_MEMBER_REMOVED = 'FACTION_MEMBER_REMOVED';
    public const TYPE_NEW_DIRECT_MESSAGE = 'NEW_DIRECT_MESSAGE';

    public const TARGET_TYPE_PUBLICATION = 'PUBLICATION';
    public const TARGET_TYPE_LEVEL = 'LEVEL';
    public const TARGET_TYPE_BADGE = 'BADGE';
    public const TARGET_TYPE_FACTION = 'FACTION';
    public const TARGET_TYPE_CONVERSATION = 'CONVERSATION';
    public const TARGET_TYPE_JOIN_REQUEST = 'JOIN_REQUEST';
