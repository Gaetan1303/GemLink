...
class ConversationParticipant
{
    ...
    public function getLastReadMessage(): ?ChatMessage
    {
    ...
    {
        return $this->lastReadMessage?->getId();
    }
    ...
    public function markRead(?ChatMessage $message): self
    {
